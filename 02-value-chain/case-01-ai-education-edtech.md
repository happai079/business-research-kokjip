...
graph LR
    subgraph SUP["지원활동"]
        I["기업 인프라 — 훈련기관·개인정보·저작권"]
        H["인적자원 — 도메인 실무 + 교수설계 결합"]
        T["기술개발 — 진단·성과 데이터 모델 / 샌드박스 / AI 튜터"]
        P["조달 — 모델 API · 클라우드 · 외부 강사"]
    end
    A1["투입·조달<br/>강사·고객사 사례·실습환경"] --> A2["운영·생산<br/>진단→실습→산출물→적용 코칭"]
    A2 --> A3["산출·배송<br/>수강생/HRD/경영진 3종 리포트"]
    A3 --> A4["마케팅·영업<br/>진단→파일럿→전사→컨설팅"]
    A4 --> A5["서비스<br/>90일 정착 지원 · VOC 루프"]
    A5 -.->|"산출물·질문 로그 재투입"| A1
    A5 --> M["마진"]
```
