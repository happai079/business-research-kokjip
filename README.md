...
<img width="800" height="500" alt="솔루션 시각화 이미지" src="https://github.com/user-attachments/assets/601e3a7d-1574-4ced-b369-35dce1cb212c" />

사용자 스토리보드

<img width="800" height="500" alt="사용자 스토리보드" src="https://github.com/user-attachments/assets/2c91c757-a9a3-4be8-b27a-004f53772f1c" />
...
├── 00-baseline-research/
│   ├── README.md                                             # 기초 리서치 디렉터리 안내
│   └── case-01-kokjip-integrated-baseline-research.md        # ★ 기초 리서치 통합본 (01~08 공식 근거 기준선)
...
│   ├── case-01-kokjip-integrated-market-sizing.md            # ★ 04 시장 규모·세그먼트 분석 통합본
...
│   ├── case-01-kokjip-integrated-persona-journey.md          # ★ 05 페르소나·고객여정지도 분석 통합본
...
│   ├── case-01-kokjip-integrated-opportunity-score.md        # ★ 06 시장 기회 점수·AOS/DOS 분석 통합본
...
├── 07-jtbd/
│   ├── case-01-kokjip-integrated-jtbd.md                     # ★ 07 JTBD·전환행동 분석 통합본
