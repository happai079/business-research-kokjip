...
단계가 **세로로 흐르고** 세 여정이 나란히 놓여 있어, 같은 높이끼리 비교하면 **어느 산업에서 무엇이 단계로 승격되는지**가 보입니다.
...
| 방향 | 내용 |
|---|---|
| **입력** | [기본 페르소나](./case-01-personas.md)(주인공 선정) · [페르소나 스펙트럼](./case-01-persona-spectrum.md)(극단 사용자의 여정은 다르게 끊긴다) · Ch01 대체재(접점 레인의 대안) · [Ch04 세그먼트](../04-tam-sam-som-market-segment-map/case-01-ai-education-edtech.md)(주인공이 속한 세그먼트) |
...
- **B2B 소프트웨어**를 범용 5단계로 그리면 **「보안 심사」와 「예산 편성 대기」가 사라집니다.** 계약이 가장 자주 멈추는 두 구간이 지워집니다.
