...
**이름은 모두 가상이며 실제 인물·기업과 무관합니다.** 문서 전체에서 **이름을 먼저 쓰고 코드는 괄호로 뒤에** 붙입니다 — 코드는 문서 간 대조용이고, 읽을 때 사람을 알아볼 수 있어야 하기 때문입니다. 상세 스펙트럼은 [01-B](./case-01-kokjip-lecture-review-prioritizer-persona-spectrum.md)와 코드가 일치합니다(P1=C1, P2=C2, P3=C3, P4=A1, P5=A2).

| 출처 | 처분 | 도출된 페르소나 | 이 서비스에서의 위치 |
|---|---|---|---|
| **L1** 국비 부트캠프 수강생 | **주 표적** | **김지원** (P1) · 복습 부채에 짓눌린 KDT 수강생 | **주 사용자 · 개인 지불자** |
| **지불 주체 — 국비 훈련기관** | **주 판매 채널** | **박성호** (P2) · 취업률을 방어해야 하는 훈련기관 운영자 | **기관 지불자 · 도입 결정권** |
| L1 생태계 | — | **이준혁** (P3) · 진도에 쫓기는 KDT 강사 | **영향자(추천 채널) + 녹음 허용 권한** |
| L2 사설 부트캠프 수강생 | 2순위 | **한도윤** (P4) · 자비로 수백만 원을 낸 수강생 | 지불 의사 최고 |
| L3 대학 취업준비 학년 | 3순위 | **오세연** (P5) · 취업 준비를 병행하는 4학년 | 에브리타임 채널 |
| 확장 기능의 상대 | 보류 | **신다혜** (P6) · 지원자를 걸러야 하는 채용 담당자 | 포트폴리오·매칭의 수요자 |
| L5·L7 | 제외 | 안티 페르소나 ([§6](#6-안티-페르소나--의도적으로-겨냥하지-않는-사람)) | — |

**이준혁 (P3)은 제품이 작동할지를 결정하지만 제품을 쓰지는 않는 페르소나입니다.** 강사는 **녹음을 허용하거나 금지할 권한**을 쥐고 있고, 동시에 워크숍 정의가 명시한 홍보 채널("국비 강사 채널")입니다. **태깅과 우선순위 판단은 강사가 하지 않습니다** — 태깅은 학습자 또는 AI가 하고, 현직자 관점의 판단은 AI가 대리합니다.

---

## 2. 주 표적 세그먼트(L1)의 페르소나

### 김지원 (P1) — 복습 부채에 짓눌린 KDT 수강생 · *주 사용자*
...
### 박성호 (P2) — 취업률을 방어해야 하는 훈련기관 운영자 · *기관 지불자*
...
### 이준혁 (P3) — 진도에 쫓기는 KDT 강사 · *영향자 + 녹음 허용 권한*
...
**이 페르소나는 기관 계약의 관문입니다.** 강사가 녹음을 금지해도 **개인 사용은 막히지 않습니다** — 강의실에서 개인 기기 녹음을 적발할 방법이 사실상 없습니다 🟡. 막히는 것은 **기관 도입**입니다. 계약서에 녹음이 들어가고 강사가 반대하면 적발 가능성이 0이어도 구매가 멈추므로, 이것은 **집행 리스크가 아니라 동의·조달 리스크**입니다(→ [01-B의 Non-user](./case-01-kokjip-lecture-review-prioritizer-persona-spectrum.md)).

**해법은 동의를 없애는 게 아니라 절차로 만드는 것입니다.** [해외 대학의 강의 녹화 실사](../04-tam-sam-som-market-segment-map/deep-research/kokjip-research.md#5-4-패턴-d--강의-영역에서는-기관이-계약-틀을-만들고-강사-동의는-여전히-개별로-받는다)에서 확인된 세계 표준은 **기관 계약 + 강사 opt-in**입니다 🟢 — 계약이 강사 동의를 대체하지 않고, UCL은 **이유 없는 거부까지 보장**합니다. 대신 매번 학습자가 부탁하는 대화가 **기관이 차수 시작 시 표준 동의서를 받는 절차**로 바뀝니다. UMass Lowell·Aberdeen처럼 **녹화물의 IP·실연권을 강사에게 남기는** 조항을 그대로 차용할 수 있습니다.
...
|---|---|
| **[01-B 페르소나 스펙트럼](./case-01-kokjip-lecture-review-prioritizer-persona-spectrum.md)** | 이준혁(강사)이 **영향자이면서 거부권자**라는 이중성 → Non-user 유형의 실체. 무료 도구로 버티는 수강생 → 전환 대상 |
...
| Ch07 JTBD | 김지원의 "뭘 먼저 봐야 할지 모르겠다"가 핵심 과업 진술문 |
...
- [ ] **기관이 이미 강의를 녹화하고 있는가** 🔴 — 그렇다면 표준 동의 절차가 이미 있어 도입 마찰이 크게 줄어든다. 훈련기관 5곳 확인으로 충분하다
- [ ] **녹음물 서버 처리의 저작권·개인정보 요건** 🔴 — 외부 유출을 막는 설계로도 **복제 자체**는 남는다. 첫 기관 계약의 법무·보안 검토 통과 여부가 걸려 있다
- [ ] 김지원이 무료 도구 대신 유료를 선택하는 지점 🔴 — [E] §5 1순위, 랜딩 테스트로 확인 가능
- [ ] 한도윤(사설 부트캠프)의 지불 저항이 정말 더 낮은가 🔴
