...
**가장 깔끔한 해법은 우리가 녹음하지 않는 것입니다** — 기관이 이미 보유한 공식 녹화를 입력으로 받으면 강사 개별 동의가 **기관 계약 한 번으로 일괄 처리**됩니다. 국비 과정의 기관 녹화 보편성은 미확인 🔴입니다.
...
- [ ] **기관이 이미 강의를 녹화하고 있는가** 🔴 — 그렇다면 강사 동의가 계약으로 일괄 처리된다. 훈련기관 5곳 확인으로 충분하다
