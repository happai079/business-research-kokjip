...
> **윤태경 (E1)이 제품의 설계 한계를 드러냅니다.** 녹음 가능 여부가 제품 작동의 **이진 조건**이므로, 금지 비율이 높으면 **강의 자료·판서 기반 대체 입력 경로**가 없는 한 그 과정은 시장에서 빠집니다. [§7](#7-2단계2차-평가로-넘기는-것)의 검증 1순위입니다.
...
| **제품 작동의 전제를 만족하는가** | 녹음 가능·실시간 강의라는 두 전제. 서민재와 윤태경이 이 기준으로 갈린다 |
