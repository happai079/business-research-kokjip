...
>
> **가장 깔끔한 우회는 우리가 녹음하지 않는 것입니다.** **기관이 이미 보유한 공식 녹화를 입력으로 받으면** 녹음 주체가 기관이 되어 강사 개별 동의가 **기관 계약 한 번으로 일괄 처리**되고, 윤태경 (E1) 유형이 사라집니다. 국비 과정은 훈련 이수 관리·결석자 보충 목적의 기관 녹화가 흔하다고 알려져 있으나 **실제 보편성은 미확인** 🔴 — [§7](#7-2단계2차-평가로-넘기는-것)의 새 검증 항목입니다.
...
- [ ] **녹음물의 서버 처리에 대한 저작권·개인정보 요건** 🔴 — 봉쇄 설계로 유출은 막아도 **복제 자체**는 남는다. 기관 계약의 법무·보안 검토에서 뜨는 항목이므로 **첫 기관 계약 전에** 정리해야 한다
