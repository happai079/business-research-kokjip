...
> **이 문서의 위치** — Ch04 세그먼트 맵에서 **사용·지불·영향 역할을 직접 도출**한 결과입니다. 극단·비활성 사용자까지 넓히는 작업은 별도 문서로 진행합니다 → **[사례 01-B 페르소나 스펙트럼](./case-01-persona-spectrum.md)** · **[사례 01-C 고객 여정지도](./case-01-journey-map.md)**
...
| 승계한 표적 세그먼트 | **L1 국비 부트캠프(KDT 등) 수강생** 주 표적 · L2 사설 부트캠프 2순위 · L3 대학 취업준비 학년 3순위 ([4] §2-3) |
| 승계한 지불 주체 구조 | 개인은 월 5,000원 안팎이 상한(무료 대체재 때문) · **국비 훈련기관이 주 판매 채널** ([4] §2-4) |
| 승계한 제외 조건 | 공무원·자격증 준비생(정답이 정해져 **인사이트 무효**) · 장기 미취업 청년(**태깅할 강의가 없음**) |
...
|---|---|---|---|
| **L1** 국비 부트캠프 수강생 | **주 표적** | **P1** 복습 부채에 짓눌린 KDT 수강생 | **주 사용자 · 개인 지불자** |
| **지불 주체 — 국비 훈련기관** | **주 판매 채널** | **P2** 취업률을 방어해야 하는 훈련기관 운영자 | **기관 지불자 · 도입 결정권** |
| L1 생태계 | — | **P3** 진도에 쫓기는 KDT 강사 | **영향자 + 인사이트 공급원** |
| L2 사설 부트캠프 수강생 | 2순위 | **P4** 자비로 수백만 원을 낸 수강생 | 지불 의사 최고 |
| L3 대학 취업준비 학년 | 3순위 | **P5** 취업 준비를 병행하는 4학년 | 에브리타임 채널 |
| 확장 기능의 상대 | 보류 | **P6** 지원자를 걸러야 하는 채용 담당자 | 포트폴리오·매칭의 수요자 |
| L5·L7 | 제외 | 안티 페르소나 ([§6](#6-안티-페르소나--의도적으로-겨냥하지-않는-사람)) | — |

**P3가 이 서비스에만 있는 페르소나입니다.** 제품의 핵심 가치가 "현직자 인사이트"인데, **국비 교육의 강사가 곧 현직자**입니다. 즉 강사는 홍보 채널이면서 **콘텐츠의 원천**이기도 합니다.

---

## 2. 주 표적 세그먼트(L1)의 페르소나

### P1. 복습 부채에 짓눌린 KDT 수강생 — *주 사용자*

| 항목 | 내용 |
|---|---|
| **유형명** | **복습 부채에 짓눌린 수강생** (The Buried Trainee) |
...
### P2. 취업률을 방어해야 하는 훈련기관 운영자 — *기관 지불자*

| 항목 | 내용 |
|---|---|
| **유형명** | **취업률을 방어해야 하는 기관 운영자** (The Placement Defender) |
...
### P3. 진도에 쫓기는 KDT 강사 — *영향자 + 인사이트 공급원*

| 항목 | 내용 |
|---|---|
| **유형명** | **진도에 쫓기는 현직자 강사** (The Rushed Practitioner-Instructor) |
...
| **사용 맥락** | **차수 시작 시 도구 안내**(홍보 채널로 명시된 "국비 강사 채널")와 **강의 중 태깅 승인·보정**. 강의 준비 시간이 부족하므로 추가 입력을 요구하면 쓰지 않는다 |
| **핵심 인용** | *"제가 수업에서 '이건 실무에서 안 씁니다'라고 한 걸 기억하는 수강생이 몇 안 돼요."* |

**이 페르소나가 제품의 진입장벽입니다.** [경쟁 실사](../04-tam-sam-som-market-segment-map/deep-research/kokjip-research.md#1-3단계--경쟁-구도-실사)에서 다글로가 이미 "대학생 강의 녹음 → 요약 → AI 퀴즈"를 무료로 제공하는 것이 확인됐습니다 🟢. 녹음·요약·퀴즈는 복제 가능하지만 **"현직자가 무엇을 중요하다고 판단했는지"의 축적은 강사 네트워크 없이 복제할 수 없습니다.** 즉 **강사 공급이 막히면 제품이 다글로와 구별되지 않습니다.**

동시에 **녹음을 금지할 수 있는 거부권자**이기도 합니다(→ [01-B의 Non-user](./case-01-persona-spectrum.md)). 진입장벽과 거부권을 같은 사람이 쥐고 있는 구조입니다.

---

## 3. 2·3순위 세그먼트의 페르소나

### P4. 자비로 수백만 원을 낸 사설 부트캠프 수강생 — *2순위*

| 항목 | 내용 |
|---|---|
| **유형명** | **본인 돈을 낸 수강생** (The Self-Funded Learner) |
...
### P5. 취업 준비를 병행하는 대학 4학년 — *3순위*

| 항목 | 내용 |
|---|---|
| **유형명** | **강의와 취준을 병행하는 4학년** (The Split-Attention Senior) |
...
### P6. 지원자를 걸러야 하는 채용 담당자

| 항목 | 내용 |
|---|---|
| **유형명** | **비슷한 지원서를 걸러야 하는 채용 담당자** (The Screener) |
...
|---|---|
| **[01-B 페르소나 스펙트럼](./case-01-persona-spectrum.md)** | P3(강사)이 **영향자이면서 거부권자**라는 이중성 → Non-user 유형의 실체. 무료 도구로 버티는 수강생 → 전환 대상 |
| **[01-C 고객 여정지도](./case-01-journey-map.md)** | **두 경로(기관 도입 · 개인 유입)의 여정이 다르다.** 기관은 차수 준비기에, 개인은 3주차 복습 부채 자각 시점에 시작한다 |
...
- [ ] **강사가 녹음·태깅을 허용하는가** 🔴 — 제품의 전제. 금지 비율이 높으면 제품 형태를 바꿔야 한다
