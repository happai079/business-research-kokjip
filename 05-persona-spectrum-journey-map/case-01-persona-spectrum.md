...
>
> **진입장벽은 강사가 아닙니다.** [R]의 경쟁 실사에서 **다글로가 이미 "강의 녹음 → 요약 → AI 퀴즈"를 무료 티어로 제공**하는 것이 확인됐으므로 🟢, 방어력은 **AI가 현직자 관점을 얼마나 정확히 대리하는지**이고 그것은 **판단의 근거 데이터**에 달려 있습니다.
...
graph TB
    subgraph CORE["Core 핵심 5 — KDT 훈련기관 한 차수 내부"]
        direction LR
        C1["<b>C1 김지원</b><br>KDT 비전공 전향 수강생<br>「뭘 먼저 봐야 할지 모르겠다」<br>주 사용자 · 판단 기준 없음"]
        C2["<b>C2 박성호</b><br>KDT 훈련기관 운영자<br>「취업률이 기관 생존이다」<br>기관 지불자 · 도입 결정"]
        C3["<b>C3 이준혁</b><br>KDT 현직자 강사<br>「다 말해줄 시간이 없다」<br>녹음 허용 권한 · 추천 채널"]
        C4["<b>C4 정다은</b><br>상위권 수강생 · 스터디 리더<br>「나는 이미 정리해뒀다」<br>비공식 확산 채널"]
        C5["<b>C5 최유진</b><br>기관 취업지원 담당자<br>「이력서가 다 똑같다」<br>확장 기능의 사내 파트너"]
    end

    subgraph ADJ["Adjacent 확장 3 — 같은 부채 · 다른 조건"]
        direction LR
        A1["<b>A1 한도윤</b><br>사설 부트캠프 수강생<br>「돈 낸 만큼 뽑아야 한다」<br>지불 의사 최고 · 규모 작음"]
        A2["<b>A2 오세연</b><br>대학 4학년<br>「전공이 쓸모 있나」<br>부채 중간 · 절박함 약함"]
        A3["<b>A3 서민재</b><br>직무 전환 준비 직장인<br>「야간 두 시간뿐」<br>니즈 최고 · 사용 맥락 다름"]
    end

    subgraph EXT["Extreme 극단 2 — 표적 안의 최다 실패"]
        direction LR
        E1["<b>E1 윤태경</b><br>녹음 금지 과정 수강생<br>「녹음 금지라고 하셨다」<br>입력 자체가 없음"]
        E2["<b>E2 강현우</b><br>생계 알바 병행 수강생<br>「끝나면 알바 간다」<br>복습 시간 0"]
    end

    subgraph NON["Non-user 비활성 2 — 진입 장벽"]
        direction LR
        N1["<b>N1 문지훈</b><br>녹음을 금지한 강사<br>「내 강의가 밖으로 나간다」<br>못 쓴다 · 차수 전체 차단"]
        N2["<b>N2 배소현</b><br>클로바·노션·다글로 사용자<br>「무료로 다 되는데」<br>안 쓴다 · 무료 조합"]
    end
...
- [ ] **AI의 「현직자 관점」이 무엇을 근거로 하는가** 🔴 — **진입장벽의 실체**([R] §6 1순위). 근거가 없으면 다글로가 프롬프트만 바꿔 따라온다
