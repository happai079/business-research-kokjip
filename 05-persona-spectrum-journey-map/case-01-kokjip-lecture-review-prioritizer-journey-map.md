...
| **우회 경로** | 기관이 **이미 보유한 공식 녹화**를 입력으로 받는다 | "그건 우리가 원래 찍던 것" | 쟁점 소멸 | **최선의 기회** — 녹음 주체가 기관이 되어 **강사 개별 동의가 계약 한 번으로 일괄 처리**되고 윤태경 유형이 사라진다. 국비 과정의 기관 녹화 보편성은 미확인 🔴 |
...
| 확인할 것 | 성립하지 않으면 |
|---|---|
| **기관이 이미 강의를 녹화하고 있는 비율** | 강사 개별 동의를 매 차수 받아야 한다. 확보되면 **계약 한 번으로 일괄 처리** |
...
|---|---|---|---|
| **1** | **봉쇄 설계와 삭제 보장을 도입 안내에 선제시 + 기관 기존 녹화를 입력 경로로 제안** (PP-N1·PP-K5) | 강사 ② = 기관 운영자 ⑤ = 학습자 ② | **조달이 막히는 순간에 개입한다.** 개인 사용은 금지로 죽지 않지만 기관 계약은 죽고, 규모는 기관에서 나온다. 기관 녹화를 쓰면 쟁점 자체가 소멸한다 |
...
| 우선순위 | 항목 | 흔들리면 바뀌는 것 |
|---|---|---|
| **1** | **기관이 이미 강의를 녹화하고 있는 비율** 🔴 | 확보되면 강사 개별 동의가 **계약 한 번으로 일괄 처리**되고 Extreme 유형이 사라진다. KDT 훈련기관 5곳 확인으로 충분하다 |
