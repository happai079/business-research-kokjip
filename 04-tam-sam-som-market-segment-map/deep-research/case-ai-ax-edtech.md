...
| 항목 | 확정 내용 | 근거 |
|---|---|---|
| 도메인 | **금융·보험의 규제·심사 문서 업무로 확정** (은행 여신심사 의견서·준법 검토·상품 심사). 후보 셋(제조 품질검사 / 금융 규제문서 / 병원 행정) 중 선택 | 경쟁사가 모두 범용 축에 있으므로 도메인 깊이가 유일한 비대칭. 금융 선택 근거는 [Ch04 §5-4](../case-01-ai-education-edtech.md#5-4-도메인을-금융으로-확정한-근거와-대가) |
