...
기준 시점: 2026년 8월 · 산정 결과: **[Ch04 사례 02 — 콕집](../case-02-kokjip-review-app.md)**
...
**7번은 난이도상 뒤에 있지만 전략적으로는 가장 중요합니다.** [Ch04 §7 ④](../case-02-kokjip-review-app.md#7-전략적-함의)가 "확장 기능이 본 수익원일 수 있다"고 결론냈고, 그 판단이 이 미확정 값 위에 서 있습니다. 확인되면 SOM의 상한 자체가 바뀝니다.

---

## 6. 이전 사례(B2B AX 플랫폼)에서 승계한 것과 버린 것

| 항목 | 승계 여부 |
|---|---|
| KDT 예산·훈련 구조 (K3·K8·K9) | **승계** — 같은 정부 훈련 시장 |
| 무료 공급이 가격 상한을 누른다는 구조 ([1A] 2-4) | **승계** — 대체재만 KOSA 무료 교육 → 클로바노트·노션으로 바뀜 |
| 부트캠프의 취업률 압박 | **승계 + 강화** — K4(취업률 -8.4%p)가 지불 동기의 근거가 됨 |
| 기업 교육 예산 동결(44.5%)·AI 교육 금액 비중 25% | **버림** — 기업 HRD 예산 논의는 학습자 측 도구와 무관 |
| 1,000인 이상 기업 수·계정당 8,000만 원 | **버림** — 구매 단위가 완전히 다름 |
| 12개 사업자 경쟁 실사 | **버림** — 그들은 기업교육 공급자이고 우리 경쟁자는 학습 도구(클로바노트·노션) |

**경쟁 구도가 완전히 교체됐습니다.** 이전 사례의 경쟁자는 멀티캠퍼스·팀스파르타 등 기업교육 사업자였지만, 이 서비스의 경쟁자는 **무료 학습 도구**입니다. 같은 산업(에듀테크)이라도 층위가 다르면 경쟁자가 다릅니다.
