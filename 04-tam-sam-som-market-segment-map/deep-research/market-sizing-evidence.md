...
1,000인 이상 기업              2,000개   ← D9 🔴
 × 도메인 필터 (금융·보험 10%)   → 200개   🔴 가정 — 제조 가정 시엔 25%였다
 × S4 비중 (76% × 75%)          → 114개   ← A7 × A6
 × 3년 내 전환 (8.8%)           → 10개    🔴 영업 사이클 기반 가정
...
xychart-beta
    ...
    y-axis "SOM 억원" 0 --> 30
    bar [6.0, 8.0, 12.0, 16.0, 25.4]
```

| 가정 | 채택값 | 범위 | SOM 영향 |
|---|---|---|---|
| **D9** 1,000인 이상 기업 수 | 2,000개 | 1,500~6,354개 | **6.0억 ~ 25.4억** (4.2배) |
...
| **도메인 필터(금융·보험 비중)** | **10%** 🔴 | 5~15% | **SOM 4.0~12.0억** |
| 3년 내 전환율 | 8.8% | 6~12% | SOM 5.5~11.0억 |
...
| **2-2** | **1,000인 이상 기업 중 금융·보험 비중** — 도메인 필터 10%의 근거 | 전국사업체조사 규모별×산업별 교차표 | 낮음 — 조회만 하면 됨 |
