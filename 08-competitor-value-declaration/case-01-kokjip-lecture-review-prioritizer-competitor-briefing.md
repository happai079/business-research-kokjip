...
### 4-1. 다글로(액션파워) — 정확도를 자산으로, 용도는 무차별로
...
### 4-2. 클로바노트(네이버) — 무료를 지속시키는 것은 선의가 아니라 수직계열화
...
### 4-3. Gemini Notebook(Google) — 콕집이 팔려던 산출물을 무료로 배포한다
...
### 4-4. Otter.ai — 카테고리를 만든 대가로 규범 리스크도 대신 떠안았다
...
### 4-6. 노션(Notion Labs) — 학생 무료는 마케팅이 아니라 LTV 설계다
...
### 4-7. 엘리스(엘리스그룹) — 우리의 지불자를 이미 고객으로 갖고 있다
...
### 4-8. 패스트캠퍼스(데이원컴퍼니) — 고객이 되기를 그만두고 직접 만들 수 있는 위치
...
> **"말로 흘러간 모든 것을, 한국어에 가장 정확한 엔진으로 다시 쓸 수 있게 만든다.**
> **우리는 특정 직업이 아니라 모든 음성을 위해 존재한다."**
...
> **"기록하는 일에는 값을 매기지 않는다.**
> **우리가 파는 것은 기록이 아니라, 그 기록이 안전하게 머무는 조직의 인프라다."**
...
### ③ Gemini Notebook (Google, 구 NotebookLM)

> **"당신이 준 자료 밖에서는 말하지 않는다.**
> **모든 답에는 출처가 붙어 있고, 그 확인 가능함이 우리가 제공하는 전부다."**
...
> **"사람이 받아적는 일을 없앤다 — 회의실에서든 강의실에서든.**
> **말이 오가는 모든 자리에서, 듣는 일에만 집중할 수 있게 한다."**
...
> **"당신의 목소리는 우리 서버에 남지 않는다.**
> **우리는 기록을 팔지, 당신의 데이터를 갖지 않는다."**
...
> **"학생일 때는 값을 받지 않는다.**
> **당신이 일하게 되었을 때, 이미 우리 안에 쌓여 있는 것에 대해 값을 받는다."**
...
> **"가르치는 일과, 가르칠 도구와, 그것이 돌아갈 인프라를 함께 만든다.**
> **우리는 교육의 참가자가 아니라 교육이 올라서는 바닥이 되려 한다."**
...
> **"커리어가 바뀌는 순간에 필요한 것을 판다.**
> **무엇이 필요한지는 시장이 정하고, 우리는 그것을 가장 빨리 강의로 만든다."**
...
| 써야 하는 문장의 조건 | 근거 |
|---|---|
| **덧셈이 아니라 뺄셈일 것** — "무엇을 안 봐도 되는가" | §6-2. 여덟 곳 중 0곳 |
...
**한 줄로** — 이 실사가 콕집에게 남기는 결론은 **"경쟁자를 이기는 선언"이 아니라 "경쟁자 여덟 곳 누구도 말하지 않은 문장을 찾는 것"** 이고, 그 문장은 **덜 보게 만드는 것**에 관한 것이어야 하며, **그 판정의 근거를 밝힐 수 없으면 선언이 아니라 광고**가 됩니다.
...
| 5 | 노션·Otter의 학생 → 직장인 **전환율** 🔴 — 습관 층 전략의 실효성 검증 | 공개 자료 없음. 참고 사례 조사 필요 |
| 6 | 엘리스 2024 실적(351억/134억)의 **감사보고서 원문** 🟡 → 🟢 승격 | DART 조회 |
